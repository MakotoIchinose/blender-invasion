...
int ED_real_mesh_mirror_spatial_table(
...
int ED_real_mesh_mirror_topo_table(struct Object *ob, struct Mesh *mesh, char mode);
...
int       real_mesh_get_x_mirror_vert(struct Object *ob, struct Mesh *mesh, int index, const bool use_topology);
...
int      *real_mesh_get_x_mirror_faces(struct Object *ob, struct BMEditMesh *em, struct Mesh *mesh);
