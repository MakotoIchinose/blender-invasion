...
bGPdata *ED_gpencil_data_get_active_v3d(Scene *scene, const Object *active_object)
{
	bGPdata *gpd = NULL;
	...
	if (active_object && (active_object->base_flag & BASE_SELECTED) && (active_object->base_flag & BASE_VISIBLED)) {
		gpd = active_object->gpd;
	}
