...
const EnumPropertyItem rna_enum_node_math_items[] = {
    ...
    {NODE_MATH_POWER, "POWER", 0, "Power", "A ^ B"},
    {NODE_MATH_LOGARITHM, "LOGARITHM", 0, "Logarithm", "log(A) base B"},
    {NODE_MATH_SQRT, "SQRT", 0, "Square Root", "sqrt(A)"},
    {NODE_MATH_ABSOLUTE, "ABSOLUTE", 0, "Absolute", "abs(A)"},
    {0, "", ICON_NONE, NULL, NULL},
    {NODE_MATH_MINIMUM, "MINIMUM", 0, "Minimum", "min(A, B)"},
    {NODE_MATH_MAXIMUM, "MAXIMUM", 0, "Maximum", "max(A, B)"},
    ...
    {NODE_MATH_FLOOR, "FLOOR", 0, "Floor", "floor(A)"},
    {NODE_MATH_CEIL, "CEIL", 0, "Ceil", "ceil(A)"},
    ...
    {NODE_MATH_ARCTAN2, "ARCTAN2", 0, "Arctan2", "arctan2(A, B)"},
    {0, NULL, 0, NULL, NULL},
};
